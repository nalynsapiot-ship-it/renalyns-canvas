        ...
        <section id="about" className="scroll-mt-16 bg-forest px-5 py-24 text-cream md:px-10 md:py-32 lg:px-16">
          <div className="mx-auto max-w-[1320px]">
            <div className="reveal grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:gap-24">
              ...
              <div className="lg:pt-14"><p className="max-w-2xl font-display text-2xl font-medium leading-relaxed text-cream/95 md:text-3xl">College student with basic knowledge of computer applications and programming. Willing to learn, gain experience, and continuously improve skills. Responsible, motivated, and eager to contribute to a team.</p>
