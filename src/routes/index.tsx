...
import portraitAsset from "../assets/renalyn-portrait.jpg.asset.json";
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px]">
            ...
            <div className="relative mx-auto min-h-[460px] md:min-h-[560px]">
              ...
              <div className="portrait-wrap absolute left-1/2 top-[98px] z-20 -translate-x-1/2 md:top-[120px]">
                ...
                <img src={portraitAsset.url} alt="Portrait of Renalyn Gonzaga" width={716} height={531} fetchPriority="high" className="profile-photo" />
        ...
        <section id="about" className="scroll-mt-16 bg-forest px-5 py-24 text-cream md:px-10 md:py-32 lg:px-16">
          <div className="mx-auto max-w-[1320px]">
            <div className="reveal grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:gap-24">
              ...
              <div className="lg:pt-14"><p className="max-w-3xl font-display text-2xl font-medium leading-relaxed text-cream/95 md:text-4xl">I translate real-world challenges into <span className="text-sage">thoughtful digital systems</span> that work for people.</p><p className="mt-8 max-w-2xl leading-8 text-cream/65">College student with basic knowledge of computer applications and programming. Willing to learn, gain experience, and continuously improve skills. Responsible, motivated, and eager to contribute to a team.</p>
